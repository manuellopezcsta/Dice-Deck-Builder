...
public class PlayerList : MonoBehaviour
{
    ...
    void FillPlayers()
    {
        list.Add(new Player("Kaiju", decks.GetDeckN(1), 20, 5, 10, GetDiceN(1), playerImage[0], PopUpManager.POPUPTARGET.PLAYER1, miniSprite[0])); // Kaiju
        list.Add(new Player("Mecha", decks.GetDeckN(2), 20, 10, 5, GetDiceN(2), playerImage[1], PopUpManager.POPUPTARGET.PLAYER1, miniSprite[1])); // Mecha
        list.Add(new Player("Valkyria", decks.GetDeckN(3), 15, 10, 10, GetDiceN(3), playerImage[2], PopUpManager.POPUPTARGET.PLAYER1, miniSprite[2])); // Valkyria
        list.Add(new Player("Ogro", decks.GetDeckN(4), 25, 5, 5, GetDiceN(4), playerImage[3], PopUpManager.POPUPTARGET.PLAYER1, miniSprite[3])); // Waldogro
        list.Add(new Player("Conejo", decks.GetDeckN(5), 10, 5, 5, GetDiceN(5), playerImage[4], PopUpManager.POPUPTARGET.PLAYER1, miniSprite[4])); // Conejo
    }
